...
class MainActivity : AppCompatActivity() {
    ...
    private fun makeColored(view: View) {
        when (view.id) {
            ...
            /*
            上面三行有点繁琐，因为setBackgroundResource必须要对对象引用，不能是id，样例代码这块直接给的是：
            R.id.red_button -> box_three_text.setBackgroundResource(R.color.my_red)
            显然这块 box_three_text 在本函数中都没有引用（即使有也是id，并非对象）。
            github上的代码也没有声明类成员，我感觉这块写错了
            已经给样例代码写feedback了，不知道他们能不能看到。
             */
